...
<body>
    <div>
            ...
            <div class="invoice__item">
                ...
                <div>
                    ...
                    <table>
                        ...
                        <tr>
                            <td class="text-center" style="text-align: center">Phone: {{ get_setting('phone')->value }}
                            </td>
                        </tr>
                    </table>
                </div>
        ...
        <div style="padding:0 1.5rem;">
                                ...
                                <tbody>
                                    ...
                                    @if ($order->discount > 0)
                                        <tr>
                                            ...
                                            <td class="currency">{{ $order->sub_total - $order->discount }}</td>
                                        </tr>
                                    @endif
                                    ...
                                    @endif
                                    <tr class="border-top">
                                        <th class="text-left" style="font-weight: 600; display: flex; font-size: 12px;">
                                            Grand Total</th>
            ...
            <div style="font-size: 13px; text-align: center; margin: 10px 0px;">Developed By : <a target="_blank"
                    style="text-decoration: none;font-weight: 700; margin-left: 5px;" href="https://classicit.com.bd">
                    Classic IT</a>
            </div>
        </div>
    </div>
