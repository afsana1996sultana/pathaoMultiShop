                            ...
                            <tbody>
                                ...
                                <tr id="order_ids{{$order->id}}">
                                    ...
                                    <td class="text-center">
                                        @php
                                            $vendorAmount = App\Models\OrderDetail::where('order_id', $order->id)->where('vendor_id', '!=', 0)->pluck('price')->sum();
                                        @endphp
                                        {{ $vendorAmount }} TK
                                    </td>
                                    <td class="text-center">
                                    ...
                                    <td class="text-end">
                                        @if(Auth::guard('admin')->user()->role == '1' || in_array('18', json_decode(Auth::guard('admin')->user()->staff->role->permissions)))
			                             <a  class="btn btn-primary btn-icon btn-circle btn-sm btn-xs" href="{{route('all_orders.vendor.show',$order->id) }}">
