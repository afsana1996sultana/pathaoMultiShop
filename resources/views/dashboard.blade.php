                ...
                <div class="row">
                    <div class="col-lg-10 m-auto">
                        <div class="row">
                            <div class="col-lg-4 col-md-5 col-xl-3">
                                ...
                                <div class="dashboard-menu">
                                    <ul class="nav flex-column" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="address-tab1" data-bs-toggle="tab" href="#address1"
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="user-password-tab" data-bs-toggle="tab"
                                                ...
                                                aria-selected="true"><i class="fi-rs-user mr-10"></i>Password Change</a>
                                        </li>
                                        <li class="nav-item">
                            ...
                            <div class="col-lg-8 col-xl-9 col-md-7 dashboard">
                                <div class="tab-content account dashboard-content">
                                    <div class="tab-pane fade active show" id="dashboard" role="tabpanel"
                                        aria-labelledby="dashboard-tab">
                                        <div class="row">
                                            <div class="col-lg-4 col-md-6 col-sm-4 col-6 item text-center">
                                                <div class="card">
                                    ...
                                    <div class="tab-pane fade" id="track-orders" role="tabpanel"
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body contact-from-area">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-8">
                                                        <form class="contact-form-style mt-30 mb-50 track__area"
