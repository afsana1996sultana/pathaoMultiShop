                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response.success) {
                                ...
                                var divition = addressadd.division_id ?? 0;
                                let options = '';
                                if(divition >0){
                                    cities.forEach(element => {
                                        options +=
                                            `<option value="${element?.city_id }" ${element?.city_id  == divition ? 'selected':''}>${element.city_name}</option>`;
                                    });
                                }else{
                                    cities.forEach(element => {
                                        options +=
                                ...
                                if(districtId >0){
                                    zones.forEach(element => {
                                        districtOptions +=
                                            `<option value="${element.zone_id}" ${element?.zone_id == districtId ? 'selected':''}>${element.zone_name}</option>`;
                                    });
                                }else{
                                    districtOptions = `<option value=" ">Select Zone</option>`
                                }
                                let UpazillaOptions = '';
                                ...
                                if(upazillaId >0){
                                    areas.forEach(element => {
                                        UpazillaOptions +=
                                            `<option value="${element.area_id}" ${element?.area_id == upazillaId ? 'selected':''}>${element.area_name}</option>`;
                                    });
                                }else{
                                    UpazillaOptions=  `<option value=" ">Select Area</option>`
                                }
                                if (user)
                                ...
                                class="form-control rounded-0"
                                placeholder="Mobile Number" value="${user.phone}" required id="edit_phone" readonly>
                                </div>
                                </div>
                                <div class="col-md-6">
                                <div class="form-group">
                                ...
                                class="form-control rounded-0"
                                placeholder="Input Email" value="${user.email !== null ? user.email : ''}" id="edit_email">
                                </div>
                                </div>
                                <div class="col-md-6">
                                <label for="division_id" class="form-label"><span class="text-danger">*</span>Cities</label>
                                ...
                                <div class="col-md-6">
                                <label for="district_id" class="form-label"><span class="text-danger">*</span>Zones</label>
                                ...
                                <div class="col-md-6">
                                <label for="upazilla_id" class="form-label">Areas</label>
                                <select class="form-control select-new edit_upazilla" aria-label="Default select example" name="upazilla_id" id="upazilla_id" >
                                    ${UpazillaOptions}
                                </select>
                                @error('upazilla_id')
                                <span>{{ $message }}</span>
