                    ...
                    <div class="header-info">
                        <ul>
                            ...
                            <li class="contact_header">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#vendor_service" class="vendorBtn">Become a Vendor</a>
                ...
                <div class="col-xxl-4 col-xl-6 col-lg-6">
                    <div class="text-center">
                        <div id="news-flash" class="d-inline-block">
                            <ul>
                                <li style="height: 20px !important">100% Secure delivery without contacting the courier
                                </li>
                            ...
                            <div class="form-group">
                                <div class="mb-4">
                                    <img id="showImage3" class="rounded avatar-lg"
                                        ...
                                        alt="Card image cap" style="width: 100px; height: 80px;">
                                </div>
                                <label for="nid"><strong>Nid Card</strong></label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <label for="image"><strong>Shop Profile : </strong><span
                                        class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <label for="image"><strong>Shop Cover Photo : </strong><span
                                        class="text-danger">*</span></label>
