...
class OrderController extends Controller
{
    ...
    public function show(Request $request, $id)
    {
        ...
        return view('backend.sales.all_orders.show', compact('order', 'shippings', 'products', 'productadd', 'cities', 'zones', 'areasshow'));
    }
    ...
    public function Vendorshow(Request $request , $id)
    {
        ...
        return view('backend.sales.all_orders.vendor_show', compact('order', 'shippings','products','productadd', 'cities', 'zones', 'areasshow'));
    }
